...
def get_untrained_l3_all_digit_model():
    input_shape = (28, 28, 1)
...
def get_trained_l3_all_digit_model(inputs, labels):
    model = get_untrained_l3_all_digit_model()
...
def get_trained_l1_all_digit_model(inputs, labels):
